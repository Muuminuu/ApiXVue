 ...
 */
class getAssetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AssetRepository' shared autowired service.
     *
     * @return \App\Repository\AssetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AssetRepository.php';

        return $container->privates['App\\Repository\\AssetRepository'] = new \App\Repository\AssetRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
