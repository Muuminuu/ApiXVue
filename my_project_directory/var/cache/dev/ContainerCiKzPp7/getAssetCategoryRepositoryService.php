 ...
 */
class getAssetCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AssetCategoryRepository' shared autowired service.
     *
     * @return \App\Repository\AssetCategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AssetCategoryRepository.php';

        return $container->privates['App\\Repository\\AssetCategoryRepository'] = new \App\Repository\AssetCategoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
